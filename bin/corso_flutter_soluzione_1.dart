...
// this function accept a param person that is required while age is optional: 
// example:  
// 1 - writePersonRequired(p: person, 10)
// 2 - writePersonRequired(p: person)
//
void writePersonRequired({required Person person, int? age}){
  print("required param function")
}
